...
public class MapsActivity extends ActionBarActivity implements FragmentDrawerMap.FragmentDrawerListener,GoogleMap.OnMarkerClickListener {
    ...
    private void setupUpdatePositionTask() {
        markerManager=new MarkerManager(mMap, GroupManager.createGroupForTest());
 ...
 public void findDirectionBetweenMeAndApt(Marker markerApt){
        if (UserManager.myIdentity!=null){
            if (UserManager.myIdentity.getLocalisation()!=null){
                findDirections(UserManager.myIdentity.getLocalisation().getLatitude(),
                        UserManager.myIdentity.getLocalisation().getLongitude(),
        ...
        adb.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                ...
                aptMarker = mMap.addMarker(new MarkerOptions().position(latLngForApt)
                        .title("Appointment").snippet(date.getText().toString()+" at "+heure.getText().toString()));
